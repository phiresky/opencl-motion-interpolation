...
#ifdef _MSC_VER
#pragma warning( \
    disable : 4201)  // non-standard extension: nameless struct / union
#elif __GNUG__
...
#define DEFINE_SWIZZLE_MASK(__d__, __i__, __j__, __k__, __l__)     \
  template <typename T, int N>                                     \
  struct __##__i__##__j__##__k__##__l__ {                          \
    inline __##__i__##__j__##__k__##__l__ &operator=(              \
        const vector<T, __d__> &b) {                               \
...
struct vector<T, 4> : __vector_base<T> {
  ...
  vector(const vector<T, 2> &_xy, T z, T w)
      : x(_xy[0]), y(_xy[1]), z(z), w(w) {}

  vector(T x, const vector<T, 2> &_yz, T w)
      : x(x), y(_yz[0]), z(_yz[1]), w(w) {}

  vector(T x, T y, const vector<T, 2> &_zw)
      : x(x), y(y), z(_zw[0]), w(_zw[1]) {}

  vector(const vector<T, 2> &_xy, const vector<T, 2> &_zw)
      : x(_xy[0]), y(_xy[1]), z(_zw[0]), w(_zw[1]) {}

  vector(const vector<T, 3> &_xyz, T w)
      : x(_xyz[0]), y(_xyz[1]), z(_xyz[2]), w(w) {}

  vector(T x, const vector<T, 3> &_yzw)
      : x(x), y(_yzw[0]), z(_yzw[1]), w(_yzw[2]) {}
...
struct __vector<T, 2> {
  ...
  inline operator vector<T, 2>() const { return vector<T, 2>(*x, *y); }
...
struct __vector<T, 3> {
  ...
  inline operator vector<T, 3>() const { return vector<T, 3>(*x, *y, *z); }
...
struct __vector<T, 4> {
  ...
  inline operator vector<T, 4>() const { return vector<T, 4>(*x, *y, *z, *w); }
...
struct matrix<T, 1, 2> : __matrix_base<T, 1, 2> {
  ...
  matrix(T k) : _m00(k), _m01(k) {}

  matrix(T _m00, T _m01) : _m00(_m00), _m01(_m01) {}
...
struct matrix<T, 1, 3> : __matrix_base<T, 1, 3> {
  ...
  matrix(T k) : _m00(k), _m01(k), _m02(k) {}

  matrix(T _m00, T _m01, T _m02) : _m00(_m00), _m01(_m01), _m02(_m02) {}
...
struct matrix<T, 1, 4> : __matrix_base<T, 1, 4> {
  ...
  matrix(T k) : _m00(k), _m01(k), _m02(k), _m03(k) {}
...
struct matrix<T, 2, 1> : __matrix_base<T, 2, 1> {
  ...
  matrix(T k) : _m00(k), _m10(k) {}

  matrix(T _m00, T _m10) : _m00(_m00), _m10(_m10) {}
...
struct matrix<T, 2, 2> : __matrix_base<T, 2, 2> {
  ...
  matrix(T k) : _m00(k), _m10(k), _m01(k), _m11(k) {}

  matrix(T _m00, T _m01, T _m10, T _m11)
      : _m00(_m00), _m10(_m10), _m01(_m01), _m11(_m11) {}
...
struct matrix<T, 2, 3> : __matrix_base<T, 2, 3> {
  ...
  matrix(T k) : _m00(k), _m10(k), _m01(k), _m11(k), _m02(k), _m12(k) {}

  matrix(T _m00, T _m01, T _m02, T _m10, T _m11, T _m12)
      : _m00(_m00),
        _m10(_m10),
        _m01(_m01),
        _m11(_m11),
...
struct matrix<T, 2, 4> : __matrix_base<T, 2, 4> {
  ...
  matrix(T _m00, T _m01, T _m02, T _m03, T _m10, T _m11, T _m12, T _m13)
      : _m00(_m00),
        _m10(_m10),
        _m01(_m01),
        _m11(_m11),
...
struct matrix<T, 3, 1> : __matrix_base<T, 3, 1> {
  ...
  matrix(T k) : _m00(k), _m10(k), _m20(k) {}

  matrix(T _m00, T _m10, T _m20) : _m00(_m00), _m10(_m10), _m20(_m20) {}
...
struct matrix<T, 3, 2> : __matrix_base<T, 3, 2> {
  ...
  matrix(T k) : _m00(k), _m10(k), _m20(k), _m01(k), _m11(k), _m21(k) {}

  matrix(T _m00, T _m01, T _m10, T _m11, T _m20, T _m21)
      : _m00(_m00),
        _m10(_m10),
        _m20(_m20),
        _m01(_m01),
...
struct matrix<T, 3, 4> : __matrix_base<T, 3, 4> {
  ...
  matrix(T _m00, T _m01, T _m02, T _m03, T _m10, T _m11, T _m12, T _m13, T _m20,
...
struct matrix<T, 4, 1> : __matrix_base<T, 4, 1> {
  ...
  matrix(T k) : _m00(k), _m10(k), _m20(k), _m30(k) {}

  matrix(T _m00, T _m10, T _m20, T _m30)
...
struct matrix<T, 4, 2> : __matrix_base<T, 4, 2> {
  ...
  matrix(T _m00, T _m01, T _m10, T _m11, T _m20, T _m21, T _m30, T _m31)
      : _m00(_m00),
        _m10(_m10),
        _m20(_m20),
        _m30(_m30),
...
struct matrix<T, 4, 4> : __matrix_base<T, 4, 4> {
  ...
  matrix(T _m00, T _m01, T _m02, T _m03, T _m10, T _m11, T _m12, T _m13, T _m20,
         T _m21, T _m22, T _m23, T _m30, T _m31, T _m32, T _m33)
      : _m00(_m00),
        _m10(_m10),
        _m20(_m20),
        _m30(_m30),
...
inline float degrees(float x) { return x * 57.295779513082320876798154814105f; }
...
T determinant(const matrix<T, 3, 3> &a) {
  return a._m00 * (a._m11 * a._m22 - a._m21 * a._m12) +
...
T determinant(const matrix<T, 4, 4> &a) {
  return a._m00 * ((a._m22 * a._m33 * a._m11 + a._m32 * a._m13 * a._m21 +
                    a._m12 * a._m23 * a._m31) -
                   (a._m32 * a._m23 * a._m11 + a._m12 * a._m33 * a._m21 +
                    a._m22 * a._m13 * a._m31)) +
         a._m10 * ((a._m32 * a._m23 * a._m01 + a._m02 * a._m33 * a._m21 +
                    a._m22 * a._m03 * a._m31) -
                   (a._m22 * a._m33 * a._m01 + a._m32 * a._m03 * a._m21 +
                    a._m02 * a._m23 * a._m31)) +
         a._m20 * ((a._m12 * a._m33 * a._m01 + a._m32 * a._m03 * a._m11 +
                    a._m02 * a._m13 * a._m31) -
                   (a._m32 * a._m13 * a._m01 + a._m02 * a._m33 * a._m11 +
                    a._m12 * a._m03 * a._m31)) +
         a._m30 * ((a._m22 * a._m13 * a._m01 + a._m02 * a._m23 * a._m11 +
                    a._m12 * a._m03 * a._m21) -
                   (a._m12 * a._m23 * a._m01 + a._m22 * a._m03 * a._m11 +
                    a._m02 * a._m13 * a._m21));
}
...
template <typename T, int N>
vector<T, N> lerp(const vector<T, N> &a, const vector<T, N> &b,
                  const vector<T, N> &t) {
  vector<T, N> c;
  for (int i = 0; i < N; i++) {
