...
class CTriMesh {
 ...
 public:
  ...
  static CTriMesh *LoadFromObj(const std::string &Path,
                               const hlsl::float4x4 &M);
  ...
  // the float array will contain triplets of vertices, each vertex having 4
  // floats as world coordinate (float4)
