...
vector<T, 4> cross(const vector<T, 4> &a, const vector<T, 4> &b,
  ...
  return vector<T, 4>(
      -a.y * d0 + a.z * d1 - a.w * d2, +a.x * d0 - a.z * d3 + a.w * d4,
      -a.x * d1 + a.y * d3 - a.w * d5, +a.x * d2 - a.y * d4 + a.z * d5);
}
...
matrix<T, 4, 4> frustum(T x0, T x1, T y0, T y1, T z0, T z1) {
  return matrix<T, 4, 4>(
      (T)2 * z0 / (x1 - x0), (T)0, (T)0, (T)0, (T)0, (T)2 * z0 / (y1 - y0),
      (T)0, (T)0, (x0 + x1) / (x0 - x1), (y0 + y1) / (y0 - y1), z1 / (z1 - z0),
      (T)1, (T)0, (T)0, -z1 * z0 / (z1 - z0), (T)0);
}

template <typename T>
matrix<T, 4, 4> frustumGL(T x0, T x1, T y0, T y1, T z0, T z1) {
  return matrix<T, 4, 4>((T)2 * z0 / (x1 - x0), (T)0, (T)0, (T)0, (T)0,
                         (T)2 * z0 / (y1 - y0), (T)0, (T)0,
                         (x0 + x1) / (x0 - x1), (y0 + y1) / (y0 - y1),
                         (z1 + z0) / (z1 - z0), (T)1, (T)0, (T)0,
                         -2.0f * z1 * z0 / (z1 - z0), (T)0);
}
...
inline const matrix<T, 4, 4> invert(const matrix<T, 4, 4> &a) {
  ...
  b._m00 = ((_zzww * a._m11 + _wzyw * a._m21 + _yzzw * a._m31) -
            (_wzzw * a._m11 + _yzww * a._m21 + _zzyw * a._m31));
  b._m01 = ((_wzzw * a._m01 + _xzww * a._m21 + _zzxw * a._m31) -
            (_zzww * a._m01 + _wzxw * a._m21 + _xzzw * a._m31));
  b._m02 = ((_yzww * a._m01 + _wzxw * a._m11 + _xzyw * a._m31) -
            (_wzyw * a._m01 + _xzww * a._m11 + _yzxw * a._m31));
  b._m03 = ((_zzyw * a._m01 + _xzzw * a._m11 + _yzxw * a._m21) -
            (_yzzw * a._m01 + _zzxw * a._m11 + _xzyw * a._m21));
  b._m10 = ((_wzzw * a._m10 + _yzww * a._m20 + _zzyw * a._m30) -
            (_zzww * a._m10 + _wzyw * a._m20 + _yzzw * a._m30));
  b._m11 = ((_zzww * a._m00 + _wzxw * a._m20 + _xzzw * a._m30) -
            (_wzzw * a._m00 + _xzww * a._m20 + _zzxw * a._m30));
  b._m12 = ((_wzyw * a._m00 + _xzww * a._m10 + _yzxw * a._m30) -
            (_yzww * a._m00 + _wzxw * a._m10 + _xzyw * a._m30));
  b._m13 = ((_yzzw * a._m00 + _zzxw * a._m10 + _xzyw * a._m20) -
            (_zzyw * a._m00 + _xzzw * a._m10 + _yzxw * a._m20));
  b._m20 = ((_zxwy * a._m13 + _wxyy * a._m23 + _yxzy * a._m33) -
            (_wxzy * a._m13 + _yxwy * a._m23 + _zxyy * a._m33));
  b._m21 = ((_wxzy * a._m03 + _xxwy * a._m23 + _zxxy * a._m33) -
            (_zxwy * a._m03 + _wxxy * a._m23 + _xxzy * a._m33));
  b._m22 = ((_yxwy * a._m03 + _wxxy * a._m13 + _xxyy * a._m33) -
            (_wxyy * a._m03 + _xxwy * a._m13 + _yxxy * a._m33));
  b._m23 = ((_zxyy * a._m03 + _xxzy * a._m13 + _yxxy * a._m23) -
            (_yxzy * a._m03 + _zxxy * a._m13 + _xxyy * a._m23));
  b._m30 = ((_yxwy * a._m22 + _zxyy * a._m32 + _wxzy * a._m12) -
            (_yxzy * a._m32 + _zxwy * a._m12 + _wxyy * a._m22));
  b._m31 = ((_xxzy * a._m32 + _zxwy * a._m02 + _wxxy * a._m22) -
            (_xxwy * a._m22 + _zxxy * a._m32 + _wxzy * a._m02));
  b._m32 = ((_xxwy * a._m12 + _yxxy * a._m32 + _wxyy * a._m02) -
            (_xxyy * a._m32 + _yxwy * a._m02 + _wxxy * a._m12));
  b._m33 = ((_xxyy * a._m22 + _yxzy * a._m02 + _zxxy * a._m12) -
            (_xxzy * a._m12 + _yxxy * a._m22 + _zxyy * a._m02));
...
template <typename T>
matrix<T, 4, 4> look_at(const vector<T, 3> &eye, const vector<T, 3> &at,
                        const vector<T, 3> &up) {
  vector<T, 3> zaxis = normalize(at - eye);
  vector<T, 3> xaxis = normalize(cross(up, zaxis));
  vector<T, 3> yaxis = cross(zaxis, xaxis);

  return matrix<T, 4, 4>(xaxis.x, yaxis.x, zaxis.x, (T)0, xaxis.y, yaxis.y,
                         zaxis.y, (T)0, xaxis.z, yaxis.z, zaxis.z, (T)0,
...
template <typename T>
vector<T, 3> mul_unit(const vector<T, 3> &a,
                      const /* unit */ quaternion<T> &b) {
...
matrix<T, 4, 4> ortho(T x0, T x1, T y0, T y1, T z0, T z1) {
  return matrix<T, 4, 4>((T)2 / (x1 - x0), (T)0, (T)0, (T)0, (T)0,
                         (T)2 / (y1 - y0), (T)0, (T)0, (T)0, (T)0,
                         (T)1 / (z1 - z0), (T)0, (x0 + x1) / (x0 - x1),
                         (y1 + y0) / (y0 - y1), z0 / (z0 - z1), (T)1);
}
